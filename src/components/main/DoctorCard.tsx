...
//         {status && (
//           <Badge
//             className="bg-[#a2eec0] text-[#217a56] absolute left-4 top-4 pr-4 rounded-full  relative before:content-[''] before:absolute before:w-2 before:h-2 before:rounded-full before:right-1 before:bg-[#217a56]"
//             variant="secondary"
//           >
//             متوفر الآن
//           </Badge>
//         )}
//         {discount && (
//           <div className="text-main text-lg font-semibold">خصم %{discount}</div>
//         )}
//       </CardHeader>
...
//         <MainButton className="mx-auto mb-4 text-lg">حجز موعد</MainButton>
...
export default function DoctorCard({
  ...
  return (
    <Card className="bg-white rounded-lg border shadow-md p-4 min-w-[15rem] relative">
      <CardHeader className="flex justify-between items-start">
        {status && (
          <Badge
